...
export const EventsPage: React.FC = () => {
    ...
    const viewAsTable = useCallback((event: React.MouseEvent) => {
                ...
                <Card.Body>
                    <Card.Title>
                        <Row>
                            <Col></Col>
                            <Col>
                                <Button variant="dark" onClick={viewAsTable}>View as Table</Button>
                            </Col>
                            <Col className='my-auto'><h5 className='my-auto'>Events</h5></Col>
                            <Col>
                                <Button variant="dark" onClick={viewAsCalendar}>View as Calendar</Button>
                            </Col>
                            <Col></Col>
                        </Row>
                    </Card.Title>
                    {view === 'table' && <EventsTable events={events} />}
